...
function Library:GetColor(color, table)
    ...
    if (color.R == nil) then
        return Color3.fromRGB(19, 119, 255)
    end
...
function Library:CreateWindow(title, color)
    ...
    function WinTypes:CreateTab(name, players)
        ...
        UIGradient.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                              ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
        UIGradient.Rotation = 90
        UIGradient.Parent = tab
        UIGradient.Transparency = NumberSequence.new {NumberSequenceKeypoint.new(0.00, 0.00),
        ...
        function TabTypes:CreateGroupbox(name, side)
            ...
            function GroupTypes:CreateToggle(name, callback)
                ...
                UIGradient_2.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                ...
                function ToggleTypes:CreateKeyBind(def, callback)
                    ...
                    local Clicked = false
                    local Sel = def
                    local Blacklisted = {"W", "A", "S", "D", "Slash", "Tab", "Backspace", "Escape", "Space", "Delete",
                                         "Unknown"}
            ...
            function GroupTypes:CreateSlider(name, min, max, def, callback)
                ...
                UIGradient_15.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                         ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                ...
                UIGradient_16.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                         ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                ...
                local function Slide(input)
                    local pos = UDim2.new(math.clamp((input.Position.X - slider.AbsolutePosition.X) /
                                                         slider.AbsoluteSize.X, 0, 1), 0, 1, 0)
                    bar.Size = pos
            ...
            function GroupTypes:CreateDropdown(name, options, callback)
                ...
                options = options or {}
                callback = callback or function(o)
                    print(o)
                end
                ...
                UIGradient_3.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                ...
                UIGradient_4.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                ...
                if (#options > 0) then
                    for i, v in pairs(options) do
                        ...
                        UIGradient_5.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00,
            ...
            function GroupTypes:CreateButton(name, callback)
                ...
                UIGradient_17.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                         ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
            ...
            function GroupTypes:CreateColorPicker(name, def, callback)
                ...
                UIGradient_18.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
                                                         ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                ...
                UIGradient_20.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 4)),
                ...
                colorframe.InputBegan:Connect(function(input)
                    if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType ==
                        Enum.UserInputType.Touch) and userinputservice:GetFocusedTextBox() == nil then
                        dragStart = input.Position
                ...
                gradient.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        ColorInput = game.RunService.RenderStepped:Connect(function()
                            local ColorX = (math.clamp(Mouse.X - colorslider.AbsolutePosition.X, 0,
                                colorslider.AbsoluteSize.X) / colorslider.AbsoluteSize.X)
                            local ColorY =
                                (math.clamp(Mouse.Y - gradient.AbsolutePosition.Y, 0, gradient.AbsoluteSize.Y) /
                                    gradient.AbsoluteSize.Y)
                ...
                colorslider.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        HueInput = game.RunService.RenderStepped:Connect(function()
                            local HueY = (math.clamp(Mouse.X - colorslider.AbsolutePosition.X, 0,
                                colorslider.AbsoluteSize.X) / colorslider.AbsoluteSize.X)
        ...
        function TabTypes:CratePlayerList(showbuttons, events)
            ...
            events = events or {}
            events.onwhitelist = events.onwhitelist or function()
            end
            events.onblacklist = events.onblacklist or function()
            end
            events.onprioritize = events.onprioritize or function()
            end
            events.onunprioritize = events.onunprioritize or function()
            end
            ...
            local function CreatePlayerCard(Name, UserId, MemberShipType, TeamColor)
                ...
                local Pfp = game.Players:GetUserThumbnailAsync(UserId, Enum.ThumbnailType.HeadShot,
                ...
                if (showbuttons) then
                    ...
                    UIGradient_2.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00,
                        Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(167, 167, 167))}
                    UIGradient_2.Rotation = 90
